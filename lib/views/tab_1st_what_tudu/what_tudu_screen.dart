...
class WhatTuduScreen extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => _Tab1stScreen();
}

class _Tab1stScreen extends State<WhatTuduScreen> {
                  ...
                  return InkWell(
                    onTap: () {
                      ...
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => WhatTuduSiteContentDetail(),
