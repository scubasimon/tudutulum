...
class _WhatTuduArticleContentDetailView extends State<WhatTuduArticleContentDetailView> {
  ...
  Widget getExploreAllLocationView() {
    return Column(
      children: [
        // getCover(
        //   _whatTuduArticleContentDetailViewModel.siteContentDetail.banner,
        //   _whatTuduArticleContentDetailViewModel.siteContentDetail.haveDeals,
        // ),
        // getTitle(
        //   _whatTuduArticleContentDetailViewModel.siteContentDetail.siteContent.title,
        //   _whatTuduArticleContentDetailViewModel.siteContentDetail.siteContent.description,
        // ),
        // getMoreInformation(_whatTuduArticleContentDetailViewModel.siteContentDetail.siteContent.moreInformation),
        // getAdvisory(_whatTuduArticleContentDetailViewModel.siteContentDetail.siteContent.advisory),
        // getOpenTimes(_whatTuduArticleContentDetailViewModel.siteContentDetail.siteContent.openingTimes),
        // getFees(_whatTuduArticleContentDetailViewModel.siteContentDetail.siteContent.fees),
        // getCapacity(_whatTuduArticleContentDetailViewModel.siteContentDetail.siteContent.capacity),
        // getEventsAndExperiences(_whatTuduArticleContentDetailViewModel.siteContentDetail.siteContent.eventsAndExps),
        // Container(
        //   height: 0.5,
        ...
        // ),
        // getIntouch(
        //   _whatTuduArticleContentDetailViewModel.siteContentDetail.siteContent.getIntouch,
        //   _whatTuduArticleContentDetailViewModel.siteContentDetail.siteContent.logo,
        // ),
        // Container(
        //   height: 0.5,
        //   width: MediaQuery.of(context).size.width,
